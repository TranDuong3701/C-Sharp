...
namespace Strings
{
    class Program
    {
        ...
        public static void Exercise3()
        {
            ...
            Console.WriteLine($"Enter a time in 24-hour time format (e.g. 18:00)");
            var input = Console.ReadLine();
        ...
        {
            Console.WriteLine($"Enter a few separated by a space: ");
            var input = Console.ReadLine();
            ...
            strings.AddRange(input.Split(' '));
            
            var pascalCase = "";
            foreach(var str in strings)
                pascalCase += str.Substring(0,1).ToUpper() + str.Substring(1).ToLower();
        ...
        public static void Exercise5()
        {
            ...
            var inadequates = new List<char>() {'u','e','o','a','i'};
            var count = 0;

            foreach(var character in input.ToLower().ToCharArray())
                if(inadequates.Contains(character)) 
                    count++;
